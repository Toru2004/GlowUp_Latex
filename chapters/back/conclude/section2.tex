...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Tối ưu hóa quy trình vận chuyển:} Hệ thống hiện mới chỉ dừng lại ở việc cập nhật trạng thái đơn hàng thủ công từ phía Admin và mô phỏng phí vận chuyển, chưa tích hợp API thực tế với các đơn vị vận chuyển (như Giao Hàng Nhanh, Viettel Post) để tính phí tự động và theo dõi lộ trình thời gian thực.
