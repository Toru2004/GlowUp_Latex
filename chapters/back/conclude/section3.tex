...
\begin{itemize}[noitemsep]
    ...
    \item \textbf{Tích hợp hệ sinh thái Logistics và Tài chính:} Kết nối trực tiếp với các đơn vị giao nhận và mở rộng thêm các hình thức thanh toán ví điện tử khác như Momo, ShopeePay, cũng như các giải pháp “Mua trước trả sau” nhằm tối ưu hóa trải nghiệm mua sắm cho người dùng.
