...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{config/}: Quản lý các cấu hình quan trọng như kết nối cơ sở dữ liệu và biến môi trường. Việc tách biệt giúp việc thay đổi môi trường triển khai trở nên dễ dàng và an toàn.
        ...
        \item \textbf{services/}: Đây là "trái tim" của hệ thống, chứa các thuật toán và logic xử lý chính. Việc tách Service giúp tránh trùng lặp mã nguồn, dễ dàng viết Unit Test và có thể tái sử dụng ở nhiều nơi khác nhau.
        \item \textbf{models/}: Ánh xạ các đối tượng nghiệp vụ vào cơ sở dữ liệu. Tầng này đảm bảo tính nhất quán và toàn vẹn dữ liệu trước khi được lưu trữ.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{graphics/main/chapter3/training_history.png}
