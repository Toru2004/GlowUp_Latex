...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{graphics/main/chapter2/section2/sequeadreview.png}
...
\begin{itemize}
    \item Admin nhập tiêu chí lọc (ví dụ: số sao, ngày đánh giá,...).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{graphics/main/chapter2/section2/sequekhachreview.png}
    \caption{Admin quản lý đánh giá}
    \label{fig:sequence_adreview}
\end{figure}
%Mô tả hoạt động khách hàng đánh giá sản phẩm
