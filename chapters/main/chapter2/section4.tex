...
Chức năng theo dõi và cập nhật trạng thái vận chuyển cho phép quản trị viên (Admin) giám sát tiến trình giao hàng, cập nhật trạng thái đơn vận chuyển và thông báo đến khách hàng. Chức năng này giúp đảm bảo thông tin giao hàng luôn chính xác, minh bạch và kịp thời.
...
\begin{itemize}
    ...
    \item Quản trị viên chọn đơn vận chuyển cần xem chi tiết.
...
\begin{itemize}
    ...
    \item Nếu cập nhật, quản trị viên chọn trạng thái mới cho đơn vận chuyển.
\end{itemize}
...
\begin{itemize}
    ...
    \item Hệ thống hiển thị thông báo cập nhật thành công cho quản trị viên.
\end{itemize}
