...
\begin{figure}[H]
    ...
    \caption{Sơ đồ hoạt động ChatbotAI RAG tư vấn sản phẩm}
...
\begin{itemize}
    ...
    \item Hệ thống hiển thị trạng thái đang xử lý (ví dụ: ``Đang nhập...'').
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ hoạt động theo dõi vận chuyển của khách hàng}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ hoạt động Quản lý vận chuyển của Admin}
    \label{fig:activity_mvc}
\end{figure}

\textbf{Mục đích:}

Chức năng quản lý vận chuyển cho phép quản trị viên (Admin) theo dõi, kiểm soát và cập nhật trạng thái vận chuyển của các đơn hàng. Thông qua chức năng này, hệ thống hỗ trợ quản lý lịch sử giao hàng, đảm bảo thông tin vận chuyển được cập nhật chính xác và kịp thời.

\textbf{Luồng hoạt động:}

Quản trị viên bắt đầu bằng việc mở trang quản lý vận chuyển trên hệ thống.

\begin{itemize}
    \item Hệ thống tải danh sách các đơn vận chuyển từ cơ sở dữ liệu.
    
    \item Danh sách đơn vận chuyển được hiển thị để quản trị viên lựa chọn.
    
    \item Quản trị viên chọn một đơn hàng cần quản lý.
...
Sau khi xem thông tin, quản trị viên có thể quyết định cập nhật trạng thái vận chuyển.

\begin{itemize}
    \item Nếu không cập nhật trạng thái, quy trình kết thúc.
    
    \item Nếu cập nhật trạng thái, quản trị viên thực hiện các bước sau:
    \begin{itemize}
...
Quy trình kết thúc sau khi trạng thái được cập nhật hoặc khi quản trị viên không thực hiện thay đổi.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{graphics/main/chapter2/section4/A_profile.jpg}
    \caption{Sơ đồ hoạt động quản lý hồ sơ cá nhân}
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ hoạt động quản lý cửa hàng}
    \label{fig:activity_store}
\end{figure}

\textbf{Mục đích:}

Chức năng quản lý cửa hàng cho phép quản trị viên (Admin) cập nhật thông tin của Shop, bao gồm thông tin mô tả và vị trí trên bản đồ. Chức năng này giúp đảm bảo dữ liệu cửa hàng luôn chính xác, hỗ trợ khách hàng tìm kiếm và liên hệ thuận tiện hơn.

\textbf{Luồng hoạt động:}

Quản trị viên bắt đầu bằng việc mở trang quản lý Shop trên hệ thống.
...
Tại trang này, quản trị viên có thể lựa chọn một trong hai loại cập nhật:

\begin{itemize}
    \item \textbf{Cập nhật thông tin chữ:}
    \begin{itemize}
        \item Quản trị viên chỉnh sửa các thông tin như tên Shop, mô tả, số điện thoại liên hệ, v.v.
    \end{itemize}
    
    \item \textbf{Cập nhật vị trí trên bản đồ:}
    \begin{itemize}
        \item Quản trị viên tìm kiếm địa chỉ trên bản đồ.
        
        \item Hệ thống hiển thị kết quả vị trí tương ứng.
        
        \item Quản trị viên chọn (chấm) vị trí Shop trên bản đồ.
        
        \item Hệ thống lấy tọa độ địa lý (vĩ độ, kinh độ) từ điểm được chọn.
    \end{itemize}
\end{itemize}

Sau khi hoàn tất chỉnh sửa, quản trị viên xác nhận cập nhật.
...
\begin{figure}[H]
    ...
    \caption{Sơ đồ hoạt động quản lý địa chỉ liên lạc}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{graphics/main/chapter2/section4/A_VC.jpg}
    \caption{Sơ đồ hoạt động theo dõi đơn hàng của khách hàng}
    \label{fig:activity_tracking}
\end{figure}

\textbf{Mục đích:}

Chức năng theo dõi đơn hàng cho phép khách hàng tra cứu trạng thái vận chuyển của đơn hàng bằng mã đơn. Thông qua chức năng này, khách hàng có thể biết tình trạng hiện tại của đơn hàng, lịch sử vận chuyển và đăng ký nhận thông báo khi trạng thái thay đổi.

\textbf{Luồng hoạt động:}

Khách hàng bắt đầu bằng việc truy cập trang theo dõi đơn hàng trên hệ thống.

\begin{itemize}
    \item Hệ thống hiển thị biểu mẫu yêu cầu nhập mã đơn hàng.
    
    \item Khách hàng nhập mã đơn và thực hiện tra cứu.
    
    \item Yêu cầu được gửi đến hệ thống để kiểm tra và lấy thông tin vận chuyển tương ứng.
\end{itemize}

\begin{itemize}
    \item Nếu đơn hàng tồn tại:
    \begin{itemize}
        \item Hệ thống trả về thông tin vận chuyển, bao gồm: mã đơn hàng, trạng thái hiện tại, thời gian cập nhật, shipper phụ trách và địa chỉ giao hàng.
        
        \item Khách hàng có thể xem lịch sử vận chuyển chi tiết của đơn hàng.
        
        \item Hệ thống hiển thị dòng thời gian (timeline) các trạng thái như: đang lấy hàng, đang giao, giao thành công hoặc thất bại kèm thời gian tương ứng.
        
        \item Khách hàng có thể đăng ký nhận thông báo khi trạng thái đơn hàng thay đổi bằng email hoặc số điện thoại.
        
        \item Hệ thống ghi nhận đăng ký và xác nhận việc nhận thông báo.
    \end{itemize}
    
    \item Nếu đơn hàng không tồn tại:
    \begin{itemize}
        \item Hệ thống hiển thị thông báo không tìm thấy đơn hàng và yêu cầu kiểm tra lại mã đơn.
    \end{itemize}
\end{itemize}

Quy trình kết thúc sau khi thông tin được hiển thị hoặc khi khách hàng rời khỏi chức năng tra cứu.
